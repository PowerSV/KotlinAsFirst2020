@file:Suppress(
    "UNUSED_PARAMETER", "ConvertCallChainIntoSequence", "NULLABILITY_MISMATCH_BASED_ON_JAVA_ANNOTATIONS",
    ...
    for (line in File(inputName).readLines()) {
        for (myString in set) {
            ...
            while (line.indexOf(myString, i, true) != -1) {
                ...
                i = line.indexOf(myString, i, true) + 1
            }
        }
    }
    return map
...
fun markdownToHtmlSimple(inputName: String, outputName: String) {
    ...
    3 - <s> - ~~
    */
    val listOfLines = File(inputName).readText().trim().split("\n")
    var i = 0
    for (line in listOfLines) {
        ...
        if (line.isNotBlank() && stack.last() == 0) stack.removeLast()
        while (i < line.length) {
            when {
